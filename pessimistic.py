...
wall_dict = wall(height, width, wall_width=3, wall_height=9, neg_mag=-30, reward_mag=100, latent_cost=0)
...
for scaling in np.arange(2, 10, 1):
   ...
   test.mdp.solve(setup_name=setup_name, policy_name=f'Pessimistic Agent: scaling={scaling:.3f}')
